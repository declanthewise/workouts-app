export const TREES = [
  {
    ...
    nodes: [
      ...
      { name: "KB Press", diff: 3, equip: "kb", desc: "Standing, press kettlebell overhead one arm at a time. Keep core braced, lock out at top.", muscles: ["frontDelt", "sideDelt", "tricep"] },
  ...
  },
  {
    ...
    nodes: [
      ...
      { name: "KB Rows", diff: 3, equip: "kb", desc: "Hinge forward, row kettlebell to hip one arm at a time. Squeeze shoulder blade at top.", muscles: ["bicep", "lat", "rearDelt", "upperBack"] },
  ...
  },
  {
    ...
    nodes: [
      ...
      { name: "KB Swings", diff: 3, equip: "kb", desc: "Hike kettlebell back, snap hips forward to swing to chest height. Arms are just hooks.", muscles: ["abs", "glute", "hamstring", "lowerBack"] },
  ...
  },
  {
    ...
    nodes: [
      ...
      { name: "Turkish Get-ups", diff: 4, equip: "kb", desc: "Lie down holding KB overhead. Stand up through a sequence of moves keeping arm locked out.", muscles: ["abs", "frontDelt", "glute", "oblique"] },
